        ...
        <div class="row">
                ...
                <div class="ltn__progress-bar-wrap">
                    <div class="section-title-area ltn__section-title-2">
                        ...
                        <h1 class="section-title">Chúng tôi sở hữu đội ngũ
                            có kỹ năng hàng đầu<span>.</span></h1>
                        <p>Đội ngũ của chúng tôi luôn nỗ lực không ngừng để mang đến chất lượng và hiệu quả cao nhất trong từng công việc.</p>
                    </div>
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-img-right">
                    <img src="{{asset('assets/clients/img/team/t-4.jpg')}}" alt="Image">
                </div>
            </div>
        </div>
    </div>
