                ...
                <div class="product-img">
                    ...
                    <div class="product-hover-action">
                        <ul>
                            ...
                            <li>
                                <a href="javescript:void(0)" title="Thêm vào giỏ hàng" class="add-to-cart-btn" data-id="{{$product->id}}">
                                    <i class="fas fa-shopping-cart"></i>
                                </a>
                            </li>
                            <li>
                                <a href="javescript:void(0)" title="Yêu thích" data-bs-toggle="modal"
